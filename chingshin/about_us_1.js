...
import origin_tea_dec from '/about_us_images/teaLine_dec.png';
import t06 from 'about_us_images/brand_story_images/t06.png';
import t07 from 'about_us_images/brand_story_images/t07.png';
import start_tea_dec from '/about_us_images/teaLine_dec.png';

class about_us_1 extends Component {
    state = {}
    render() {
        return (
            <body>
                ...
                <main>
                    ...
                    <div className="row brandOriginContent ">
                        <div className="col-2">
                            ...
                            <img className="origin_tea_dec" src= {origin_tea_dec} />
                        </div>
                    ...
                    <div className=" row brandStartContent">
                        ...
                        <div className="col-2">
                            ...
                            <img className="start_tea_dec" src={start_tea_dec} />
                        </div>
                    </div>
                    {/* 品牌精神 */}
